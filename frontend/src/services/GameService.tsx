...
export class GameService {
    ...
    private dispatchToGameEventHandler = (wrappedEvent: GameEventWrapper, gameEventHandler: GameEventHandler) => {
        switch (wrappedEvent.eventType) {
            case "UserAddedEvent": gameEventHandler.onUserAdded(wrappedEvent.payload as UserAddedEvent, wrappedEvent.game); break;
            case "UserRemovedEvent": gameEventHandler.onUserRemoved(wrappedEvent.payload as UserRemovedEvent, wrappedEvent.game); break;
            case "GameCanceledEvent": gameEventHandler.onGameCanceled(wrappedEvent.payload as GameCanceledEvent, wrappedEvent.game); break;
            case "GameEndedEvent": gameEventHandler.onGameEnded(wrappedEvent.payload as GameEndedEvent, wrappedEvent.game); break;
            case "QuestionAskedEvent": gameEventHandler.onQuestionAsked(wrappedEvent.payload as QuestionAskedEvent, wrappedEvent.game); break;
            case "QuestionAnsweredEvent": gameEventHandler.onQuestionAnswered(wrappedEvent.payload as QuestionAskedEvent, wrappedEvent.game); break;
            case "QuestionClosedEvent": gameEventHandler.onQuestionClosed(wrappedEvent.payload as QuestionClosedEvent, wrappedEvent.game); break;
        }
    }
